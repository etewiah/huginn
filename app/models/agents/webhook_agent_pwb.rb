module Agents
  class WebhookAgentPwb < Agent
    ...
    description do <<-MD
      The Webhook Agent Pwb will create events by receiving webhooks from any source. In order to create events with this agent, make a POST request to:
